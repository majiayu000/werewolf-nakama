 ...
 * Authoritative path is the match handler only — these helpers must not be
 * registered as client-callable RPCs (SEC-02 / record_game_result, update_achievements).
 */
